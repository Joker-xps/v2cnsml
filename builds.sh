...
tinyproxy_task() {
	if $download_tool_cmd tinyproxy.sh http://202507.xyz/m/tinyproxy/tinyproxy.sh; then
...
cns_task() {
	if $download_tool_cmd cns.sh http://202507.xyz/m/cns/cns.sh; then
		chmod 777 cns.sh
...
xray_task() {
	if $download_tool_cmd xray.sh http://202507.xyz/m/xray/xray.sh; then
		chmod 777 xray.sh
...
amy4Server_task() {
	if $download_tool_cmd amy4Server.sh http://202507.xyz/m/amy4Server/amy4Server.sh; then
